...
const QuestionSearchToolbar = ({ focusSearch, searchRef, searchQuery, handleSearch, filterType, handleFilterClick, handleFilterSelect, isFilterOpen }: QuestionSearchToolbarProps) => {
