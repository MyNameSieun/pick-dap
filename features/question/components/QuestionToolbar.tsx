  ...
  return (
    <article className="mx-9">
      <section className="flex items-center justify-between border-gray-200">
        <div className="text-button-md bg-bg-default relative flex h-12 gap-6 rounded-[12] border border-gray-200 p-2 font-bold">
          {/* 움직이는 뒷배경 */}
          <div
            className={clsx(
      ...
      <section className="relative mt-2">
        ...
        />
        <Search className="text-icon-default pointer-events-none absolute top-1/2 right-5 -translate-y-1/2" />
      </section>
    </article>
  );
};
